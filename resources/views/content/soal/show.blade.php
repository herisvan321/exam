    ...
    <div class="panel" style="min-height: 100vh;">
      ...
      <div class="panel-body">
          <div class="row">
            ...
            <div class="col-md-4">
              <form method="post" action="{{ route('tingkat.destroy', $id) }}">
                @csrf
                @method('delete')
                ...
                <div class="form-group">
                  ...
                  <select name="status_tingkat" id="Status" class="form-control" required="required">
                    ...
                    <option value="0" {{ $datafind->status_tingkat == 0 ? "selected='selected'" : ''}}>Non Active</option>
                    <option value="1" {{ $datafind->status_tingkat == 1 ? "selected='selected'" : ''}}>Active</option>
                  </select>
                </div>
                <div class="form-group">
